...
import { TemplateDrivenForm1Component } from './template-driven-form/template-driven-form1.component';
...
export const routes: Routes = [
  ...
  { path: 'template-driven-form', component: TemplateDrivenForm1Component },
